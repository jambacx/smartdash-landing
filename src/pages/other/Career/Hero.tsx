                ...
                <Row className="align-items-center">
                    <Col lg={6} md={6}>
                        ...
                        <p className="fs-16 text-muted pt-3 w-75" style={{ textAlign: 'justify' }}>
                            Smartdash нь танай компани болон таны хувийн фейсбүүк хуудасны пост, коммент, лайк зэрэг
                            дата мэдээлэлд AI технологиор анализ хийх үйлчилгээ юм. Та энэхүү үйлчилгээг ашигласнаар
                            хэрэглэгчийн сэтгэл ханамжийг тухай бүрд бодитоор үнэлж дүгнэх боломжтой. Мөн сошиал
                            сурталчилгааны үр дүнгээ шууд хэмжин, хэрэглэгчийн сэтгэл ханамжийг нэмэгдүүлэх төлөвлөгөө
                            боловсруулахад энэхүү сошиал аналитик үйлчилгээний веб туслах болно.
                        </p>
